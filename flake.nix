{
  description = "TrangQuynhCode development flake";
  ...
  outputs =
    ...
    let
      ...
      packageJson = builtins.fromJSON (builtins.readFile ./packages/trangquynhcode/package.json);
      bunTarget = {
    ...
    in
    {
      ...
      packages = forEachSystem (
        ...
        let
          ...
          mkOpencode = pkgs.callPackage ./nix/trangquynhcode.nix { };
          mkDesktop = pkgs.callPackage ./nix/desktop.nix { };

          trangquynhcodePkg = mkOpencode {
          ...
          desktopPkg = mkDesktop {
            ...
            trangquynhcode = trangquynhcodePkg;
          };
        in
        {
          default = self.packages.${system}.trangquynhcode;
          trangquynhcode = trangquynhcodePkg;
          desktop = desktopPkg;
        }
      );
