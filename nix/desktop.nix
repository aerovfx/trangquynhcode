...
rustPlatform.buildRustPackage rec {
  ...
  desktopItems = lib.optionals stdenv.isLinux [
    (makeDesktopItem {
      name = "ai.trangquynhcode.trangquynhcode";
      desktopName = "TrangQuynhCode";
      comment = "Open source AI coding agent";
      exec = "trangquynhcode-desktop";
      icon = "trangquynhcode";
      terminal = false;
      type = "Application";
      categories = [ "Development" "IDE" ];
      startupWMClass = "trangquynhcode";
    })
  ];
  ...
  preBuild = ''
    ...
    cp ${args.trangquynhcode}/bin/trangquynhcode packages/desktop/src-tauri/sidecars/trangquynhcode-cli-$targetTriple
  ...
  postInstall = lib.optionalString stdenv.isLinux ''
    ...
    cp ../../../packages/desktop/src-tauri/icons/prod/128x128.png $out/share/icons/hicolor/128x128/apps/trangquynhcode.png

    # Wrap the binary to ensure it finds the libraries
    wrapProgram $out/bin/trangquynhcode-desktop \
  ...
  meta = with lib; {
    description = "TrangQuynhCode Desktop App";
    homepage = "https://trangquynhcode.ai";
    license = licenses.mit;
    maintainers = with maintainers; [ ];
    mainProgram = "trangquynhcode-desktop";
