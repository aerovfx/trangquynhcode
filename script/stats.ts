...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/anomalyco/trangquynhcode/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for anomalyco/trangquynhcode...\n")
...
console.log("Fetching npm all-time downloads for trangquynhcode-ai...\n")
const npmDownloads = await fetchNpmDownloads("trangquynhcode-ai")
