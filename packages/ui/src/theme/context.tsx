...
const STORAGE_KEYS = {
  THEME_ID: "trangquynhcode-theme-id",
  COLOR_SCHEME: "trangquynhcode-color-scheme",
  THEME_CSS_LIGHT: "trangquynhcode-theme-css-light",
  THEME_CSS_DARK: "trangquynhcode-theme-css-dark",
} as const
