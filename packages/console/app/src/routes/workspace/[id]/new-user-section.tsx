...
import { Key } from "@trangquynhcode-ai/console-core/key.js"
    ...
    <Show when={isNew()}>
      <div class={styles.root}>
        <div data-component="feature-grid">
          ...
          <div data-slot="feature">
            <h3>No Lock-in</h3>
            <p>Use Zen with any coding agent, and continue using other providers with trangquynhcode whenever you want.</p>
          </div>
        </div>
        ...
        <div data-component="next-steps">
          <ol>
            ...
            <li>
              Run <code>trangquynhcode auth login</code> and select trangquynhcode
            </li>
            <li>Paste your API key</li>
            <li>
              Start trangquynhcode and run <code>/models</code> to select a model
            </li>
          </ol>
        </div>
      </div>
