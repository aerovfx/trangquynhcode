...
import desktopAppIcon from "../../asset/lander/trangquynhcode-desktop-icon.png"
...
export default function Download() {
  ...
  return (
    <main data-page="download">
      <Title>TrangQuynhCode | Download</Title>
      <Link rel="canonical" href={`${config.baseUrl}/download`} />
      <Meta name="description" content="Download TrangQuynhCode for macOS, Windows, and Linux" />
        ...
        <div data-component="content">
          <section data-component="download-hero">
            <div data-component="hero-icon">
              <img src={desktopAppIcon} alt="TrangQuynhCode Desktop" />
            </div>
            <div data-component="hero-text">
              <h1>Download TrangQuynhCode</h1>
          ...
          <section data-component="download-section">
            <div data-component="section-label">
              <span>[1]</span> TrangQuynhCode Terminal
            </div>
            <div data-component="section-content">
              <button
                data-component="cli-row"
                onClick={handleCopyClick("curl -fsSL https://trangquynhcode.ai/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>trangquynhcode.ai/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g trangquynhcode-ai")}>
                <code>
                  npm i -g <strong>trangquynhcode-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g trangquynhcode-ai")}>
                <code>
                  bun add -g <strong>trangquynhcode-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/trangquynhcode")}>
                <code>
                  brew install <strong>anomalyco/tap/trangquynhcode</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S trangquynhcode")}>
                <code>
                  paru -S <strong>trangquynhcode</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            <div data-component="section-label">
              <span>[2]</span> TrangQuynhCode Desktop (Beta)
            </div>
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask trangquynhcode-desktop")}>
                <code>
                  brew install --cask <strong>trangquynhcode-desktop</strong>
                </code>
                <CopyStatus />
              </button>
          ...
          <section data-component="download-section">
            <div data-component="section-label">
              <span>[3]</span> TrangQuynhCode Extensions
            </div>
            <div data-component="section-content">
              <div data-component="download-row">
                <div data-component="download-info">
                ...
                <a href="https://trangquynhcode.ai/docs/ide/" data-component="action-button">
                  Install
                </a>
              </div>
          ...
          <section data-component="download-section">
            <div data-component="section-label">
              <span>[4]</span> TrangQuynhCode Integrations
            </div>
            <div data-component="section-content">
              <div data-component="download-row">
                <div data-component="download-info">
                ...
                <a href="https://trangquynhcode.ai/docs/github/" data-component="action-button">
                  Install
                </a>
              </div>
              ...
              <div data-component="download-row">
                ...
                <a href="https://trangquynhcode.ai/docs/gitlab/" data-component="action-button">
                  Install
                </a>
              </div>
            </div>
          ...
          <ul>
            <li>
              <Faq question="What is TrangQuynhCode?">
                TrangQuynhCode is an open source agent that helps you write and run code with any AI model. It's available as
            ...
            <li>
              <Faq question="Do I need extra AI subscriptions to use TrangQuynhCode?">
                Not necessarily, but probably. You'll need an AI subscription if you want to connect TrangQuynhCode to a paid
                provider, although you can work with{" "}
                <a href="/docs/providers/#lm-studio" target="_blank">
                  local models
                </a>{" "}
                for free. While we encourage users to use <A href="/zen">Zen</A>, TrangQuynhCode works with all popular
            ...
            <li>
              <Faq question="How much does TrangQuynhCode cost?">
                TrangQuynhCode is 100% free to use. Any additional costs will come from your subscription to a model provider.
                While TrangQuynhCode works with any model provider, we recommend using <A href="/zen">Zen</A>.
              </Faq>
            </li>
            <li>
              <Faq question="What about data and privacy?">
                Your data and information is only stored when you create sharable links in TrangQuynhCode. Learn more about{" "}
