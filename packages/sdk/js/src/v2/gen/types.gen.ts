...
/**
 * Server configuration for trangquynhcode serve and web commands
 */
...
export type Config = {
  ...
  server?: ServerConfig
  /**
   * Command configuration, see https://trangquynhcode.ai/docs/commands
   */
  command?: {
    [key: string]: {
      template: string
  ...
  /**
   * Agent configuration, see https://trangquynhcode.ai/docs/agents
   */
  agent?: {
    plan?: AgentConfig
    build?: AgentConfig
