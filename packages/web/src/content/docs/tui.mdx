---
title: TUI
description: Using the TrangQuynhCode terminal user interface.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

TrangQuynhCode provides an interactive terminal interface or TUI for working on your projects with an LLM.

Running TrangQuynhCode starts the TUI for the current directory.
...
```bash
trangquynhcode /path/to/project
```
...
When using the TrangQuynhCode TUI, you can type `/` followed by a command name to quickly execute actions. For example:
...
Add a provider to TrangQuynhCode. Allows you to select from available providers and add their API keys.
...
Exit TrangQuynhCode. _Aliases_: `/quit`, `/q`
...
You can customize TUI behavior through your TrangQuynhCode config file.
