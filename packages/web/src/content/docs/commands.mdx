...
Create `.trangquynhcode/commands/test.md`:

```md title=".trangquynhcode/commands/test.md"
---
...
You can add custom commands through the TrangQuynhCode config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your TrangQuynhCode [config](/docs/config):

```json title="trangquynhcode.jsonc" {4-12}
{
...
- Global: `~/.config/trangquynhcode/commands/`
- Per-project: `.trangquynhcode/commands/`

```markdown title="~/.config/trangquynhcode/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".trangquynhcode/commands/component.md"
---
...
```md title=".trangquynhcode/commands/create-file.md"
---
...
```md title=".trangquynhcode/commands/analyze-coverage.md"
---
...
```md title=".trangquynhcode/commands/review-changes.md"
---
...
```md title=".trangquynhcode/commands/review-component.md"
---
...
trangquynhcode includes several built-in commands like `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
