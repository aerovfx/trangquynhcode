...
import type { MessageV2 } from "trangquynhcode/session/message-v2"
import type { Message } from "trangquynhcode/session/message"
import type { Session } from "trangquynhcode/session/index"
        ...
        <div data-component="header">
          ...
          <div data-component="header-details">
            <ul data-component="header-stats">
              <li title="trangquynhcode version" data-slot="item">
                <div data-slot="icon" title="trangquynhcode">
