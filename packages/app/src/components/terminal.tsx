...
import { resolveThemeVariant, useTheme, withAlpha, type HexColor } from "@trangquynhcode-ai/ui/theme"
...
export const Terminal = (props: TerminalProps) => {
  ...
  onMount(async () => {
    ...
    if (window.__TRANGQUYNHCODE__?.serverPassword) {
      url.username = "trangquynhcode"
      url.password = window.__TRANGQUYNHCODE__?.serverPassword
    }
