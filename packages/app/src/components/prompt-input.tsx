import { useFilteredList } from "@trangquynhcode-ai/ui/hooks"
import {
  createEffect,
  on,
  Component,
...
import { FileIcon } from "@trangquynhcode-ai/ui/file-icon"
...
import { Select } from "@trangquynhcode-ai/ui/select"
import { getDirectory, getFilename } from "@trangquynhcode-ai/util/path"
import { useDialog } from "@trangquynhcode-ai/ui/context/dialog"
import { ImagePreview } from "@trangquynhcode-ai/ui/image-preview"
...
import { createTrangquynhcodeClient, type Message, type Part } from "@trangquynhcode-ai/sdk/v2/client"
import { Binary } from "@trangquynhcode-ai/util/binary"
import { showToast } from "@trangquynhcode-ai/ui/toast"
import { base64Encode } from "@trangquynhcode-ai/util/encode"
  ...
  const handleSubmit = async (event: Event) => {
    ...
    if (isNewSession) {
      ...
      if (sessionDirectory !== projectDirectory) {
        client = createTrangquynhcodeClient({
          baseUrl: sdk.url,
