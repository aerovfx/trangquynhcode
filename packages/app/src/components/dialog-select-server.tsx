...
import { List } from "@trangquynhcode-ai/ui/list"
...
import { createTrangquynhcodeClient } from "@trangquynhcode-ai/sdk/v2/client"
import { useNavigate } from "@solidjs/router"

type ServerStatus = { healthy: boolean; version?: string }

async function checkHealth(url: string, fetch?: typeof globalThis.fetch): Promise<ServerStatus> {
  const sdk = createTrangquynhcodeClient({
    baseUrl: url,
    fetch,
...
export function DialogSelectServer() {
  ...
  return (
    <Dialog title="Servers" description="Switch which TrangQuynhCode server this app connects to.">
