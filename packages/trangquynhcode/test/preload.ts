...
const dir = path.join(os.tmpdir(), "trangquynhcode-test-data-" + process.pid)
...
process.env["TRANGQUYNHCODE_TEST_HOME"] = testHome
...
const cacheDir = path.join(dir, "cache", "trangquynhcode")
...
process.env["TRANGQUYNHCODE_DISABLE_MODELS_FETCH"] = "true"
