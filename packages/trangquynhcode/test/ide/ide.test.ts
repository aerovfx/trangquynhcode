...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders TRANGQUYNHCODE_CALLER", () => {
    process.env["TRANGQUYNHCODE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode TRANGQUYNHCODE_CALLER", () => {
    process.env["TRANGQUYNHCODE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown TRANGQUYNHCODE_CALLER", () => {
    process.env["TRANGQUYNHCODE_CALLER"] = "unknown"
