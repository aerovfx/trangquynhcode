...
const mockPlugin = () => ({})
mock.module("trangquynhcode-copilot-auth", () => ({ default: mockPlugin }))
mock.module("trangquynhcode-anthropic-auth", () => ({ default: mockPlugin }))
mock.module("@gitlab/trangquynhcode-gitlab-auth", () => ({ default: mockPlugin }))
