...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/trangquynhcode.git")).toEqual({ owner: "sst", repo: "trangquynhcode" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/trangquynhcode")).toEqual({ owner: "sst", repo: "trangquynhcode" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/trangquynhcode.git")).toEqual({ owner: "sst", repo: "trangquynhcode" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/trangquynhcode")).toEqual({ owner: "sst", repo: "trangquynhcode" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/trangquynhcode.git")).toEqual({ owner: "sst", repo: "trangquynhcode" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/trangquynhcode")).toEqual({ owner: "sst", repo: "trangquynhcode" })
})
