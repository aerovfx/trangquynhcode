...
import trangquynhcode from "./theme/trangquynhcode.json" with { type: "json" }
...
export const { use: useTheme, provider: ThemeProvider } = createSimpleContext({
  ...
  init: (props: { mode: "dark" | "light" }) => {
    ...
    const [store, setStore] = createStore({
      ...
      active: (sync.data.config.theme ?? kv.get("theme", "trangquynhcode")) as string,
      ready: false,
    })
    ...
    function init() {
      ...
      getCustomThemes()
        ...
        .catch(() => {
          setStore("active", "trangquynhcode")
        })
        .finally(() => {
    ...
    const values = createMemo(() => {
      return resolveTheme(store.themes[store.active] ?? store.themes.trangquynhcode, store.mode)
    })
