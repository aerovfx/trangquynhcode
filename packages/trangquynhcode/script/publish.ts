...
const { binaries } = await import("./build.ts")
{
  ...
  console.log(`smoke test: running dist/${name}/bin/trangquynhcode --version`)
  await $`./dist/${name}/bin/trangquynhcode --version`
}
...
if (!Script.preview) {
  ...
  const image = "ghcr.io/anomalyco/trangquynhcode"
